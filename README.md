...
> 문의 사항은 GitHub Issue 또는 베라서버 `미테리`로 문의 바랍니다.
...
- `끄기` 프리셋을 선택한 후 `Ctrl+Alt+F12`로 디버깅 옵션 창을 열고, 상단의 언어 선택 콤보박스에서 변경할 수 있습니다.
- 언어를 변경하면 프로그램이 재시작되며, 이후 모든 UI가 선택한 언어로 표시됩니다.

    <img src="https://github.com/user-attachments/assets/ba1d0ce4-5fa8-4549-bd37-1c586028c2a9" width="50%" alt="image" />
