...
- `백그라운드에서 ESC / Enter 입력 시 필터키 끄기` 기능은 RawInput(`RegisterRawInputDevices` + `WM_INPUT`) 이벤트로 해당 키 입력을 감지해 동작합니다. 입력을 가로채지 않고 관찰만 하는 비침습 방식이며, 관련 옵션을 끄면 감지 루틴은 비활성화됩니다.
